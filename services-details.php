...
<title>Zamboanga Doctors' Hospital, Inc. | <?= htmlspecialchars($service['name']) ?></title>
...
<section class="section-wrapper">
    ...
    <div class="content-container">
        ...
        <div class="image-card">
            <img src="<?= htmlspecialchars($service['image'] ?: '/hms/admin/images/default.jpg') ?>"
    ...
    <?php foreach (explode("\n", nl2br($service['description'])) as $para): ?>
        <?php $para = trim(strip_tags($para, '<br>')); ?>
        <?php if ($para): ?>
            <p style="text-align: justify; hyphens: auto; text-transform: none; white-space: pre-line;"><?= $para ?></p>
        <?php endif; ?>
    <?php endforeach; ?>
<?php else: ?>
